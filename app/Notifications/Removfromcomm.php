...
class Removfromcomm extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        $body = sprintf(' You have been removed from %s community . Message the admin to understand why. {click leads to:  community profile page}.',
        $this->community->name,      
        );
