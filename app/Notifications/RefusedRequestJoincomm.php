...
class RefusedRequestJoincomm extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        $body = sprintf(' Your request to join %s community has been refused. Try to send a message to the admin! {click leads to: exact community profile page}.',
        $this->community->name,      
        );
