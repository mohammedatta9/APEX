...
class MakeAdmin extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        $body = sprintf('maded you an admin to %s community. Congrats! You can message the admin if you don’t like this. {click leads to: community profile page}.',
            $this->community->name,      
        );
