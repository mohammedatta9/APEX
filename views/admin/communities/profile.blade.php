                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-0">
                                ...
                                <ul class="nav nav-tabs" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" data-bs-toggle="tab" href="#Post" role="tab"
                                           aria-selected="true">Community detail</a>
                                    </li>
                                    
                                    <li class="nav-item">
                                        <a class="nav-link" data-bs-toggle="tab" href="#Settings" role="tab"
                                           aria-selected="false">Community Members</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-bs-toggle="tab" href="#posts" role="tab"
                                           aria-selected="false">Community posts</a>
                                    </li>
                                </ul>
                                ...
                                <div class="tab-content">
                                    ...
                                    <h5 class=" client-name fw-bold">BY : {{$c->user->first_name}} {{$c->user->last_name}}</h5>
                                    <form name="" method="post" action="{{ route('admin.communities.edit') }}"   enctype= "multipart/form-data" >
                                     @csrf
                                     <input   type="text" name="id" value="{{$c->id}}"  style="display:none;">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <input class="form-check-input" value="1" name="featured_service" type="checkbox"   >
                                            <label class="form-check-label" for="customSwitchSuccess">Featured community</label>
                                        </div>
                                     </div>
                                        </div><br>
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" name="name" type="text" value="{{$c->name}}" id="example-text-input">
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                            <textarea class="form-control" name="about" rows="5" >{{$c->about}}</textarea>                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            {{ $industry->id == $c->category_id ? 'selected' : '' }}
                                                        ...
                                                        <table class="table table-striped">
                                                            ...
                                                            @foreach($c->members as $m)
                                                                <tr class="R_m{{$m->id}}">
                                                                    ...
                                                                    <td> <span> <a href="#!" class="deletem_b" deletem_b="{{$m->id}}">Delete</a></span></td>
                                                                </tr>
                                                            @endforeach
                                                            </tbody>
                                                        </table><!--end /table-->
                                        ...
                                        <div class="card">
                                                    <div class="table-responsive">
                                                        <table class="table table-striped">
                                                            ...
                                                            <tbody>
                                                            @foreach($c->community_posts as $m)
                                                                <tr>
                                                                <td>{{ $m->id }}</td>
                                                                <td>{{ $m->title}}</td>
                                                                <td>{{ $m->user->first_name }} {{ $m->user->last_name }}</td>
                                                                 <td>  <a href="{{ route('admin.communities.post', $m->id)}}"><i class=" far fa-edit  text-secondary font-20"></i></a>
                                                                <a href="{{ route('admin.communities.post', $m->id)}} "><i class=" las la-trash-alt  text-secondary font-20"></i></a>
                                                                </td>
                                                                </tr>
                                                            @endforeach
                                                            </tbody>
