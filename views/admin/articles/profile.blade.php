                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-0">
                                ...
                                <ul class="nav nav-tabs" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" data-bs-toggle="tab" href="#Post" role="tab"
                                           aria-selected="true">Article detail</a>
                                    </li>
                                ...
                                <div class="tab-content">
                                    ...
                                    <form name="" method="post" action="{{ route('admin.article.edit') }}"   enctype= "multipart/form-data" >
                                     @csrf
                                     <input   type="text" name="id" value="{{$c->id}}"  style="display:none;">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <input class="form-check-input" value="1" name="approved_by" type="checkbox" @if($c->approved_by == 1) checked @endif >
                                            <label class="form-check-label" for="customSwitchSuccess">Approved</label>
                                        </div>
                                     </div>
                                        </div><br>
                                        <div class="mb-3 row">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" name="sub_title" type="text" value="{{$c->sub_title}}" id="example-text-input">
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                            <textarea class="form-control" name="text" rows="5" >{{$c->text}}</textarea>                                            </div>
                                        </div>
